...
const iconStyle: ViewStyle = { width: iconSize, aspectRatio: 1 };

export const TOPIC_ICONS: Record<string, JSX.Element> = {
  general: <GeneralIcon style={iconStyle} />,
  geography: <GeographyIcon style={iconStyle} />,
  history: <HistoryIcon style={iconStyle} />,
  showbiz: <ShowbizIcon style={iconStyle} />,
  music: <MusicIcon style={iconStyle} />,
